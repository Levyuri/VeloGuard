<div id="intro" align="center">
  <h1>VeloGuard</h1>
  <h3>VeloGuard is a plugin-based security/firewall solution for <a href="https://www.spigotmc.org/wiki/bungeecord/">BungeeCord</a> and <a href="https://velocitypowered.com/">Velocity</a> proxies.</h3>
  <br />
</div>

## Useful Links

- [Download](https://github.com/Levyuri/VeloGuard/releases)
...
### The VeloGuard solution

Server admins install VeloGuard (just an ordinary plugin!) on their proxies and backend servers.

* On the **proxy**, VeloGuard adds a secret "authentication token" to the login handshake.
* On the **backend** (Spigot etc. server), VeloGuard checks login handshakes to ensure they contain an allowed authentication token. 
...
If you have access to the underlying system and are able to setup firewall rules using iptables (or otherwise), I strongly recommend you do so. Then, install VeloGuard as well.

See [INSTALLATION.md](INSTALLATION.md) for a detailed install guide.

## License

VeloGuard is licensed and made available under the permissive MIT license. Please see [LICENSE.txt](LICENSE.txt) for more information.
