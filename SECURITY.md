...
Serious vulnerabilities should be reported in private. The project will follow the patches and improvements applied by the [source project lucko](https://github.com/lucko/BungeeGuard) and [source project NickUC](https://github.com/lucko/BungeeGuard).

# Security Patches

This page will be updated with any notices about security issues in VeloGuard.
